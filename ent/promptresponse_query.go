...
func (prq *PromptResponseQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (prq *PromptResponseQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (prq *PromptResponseQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (prq *PromptResponseQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (prq *PromptResponseQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (prq *PromptResponseQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := prq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (prq *PromptResponseQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(promptresponse.Table, promptresponse.Columns, sqlgraph.NewFieldSpec(promptresponse.FieldID, field.TypeUUID))
	_spec.From = prq.sql
