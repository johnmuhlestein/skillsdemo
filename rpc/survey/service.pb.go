...
func (x *MeasureFlags) GetLabels() string {
	if x != nil {
		return x.Labels
	}
	return ""
...
type SurveyResp struct {
	...
	Prompts       *Prompt      `protobuf:"bytes,6,opt,name=prompts,proto3,oneof" json:"prompts,omitempty"`
}
...
func (x *SurveyResp) GetAppointmentId() string {
	if x != nil {
...
type SurveyReq struct {
	...
	Prompts       *Prompt      `protobuf:"bytes,5,opt,name=prompts,proto3,oneof" json:"prompts,omitempty"`
}

func (x *SurveyReq) Reset() {
	*x = SurveyReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *SurveyReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SurveyReq) ProtoMessage() {}

func (x *SurveyReq) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_survey_service_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SurveyReq.ProtoReflect.Descriptor instead.
func (*SurveyReq) Descriptor() ([]byte, []int) {
	return file_rpc_survey_service_proto_rawDescGZIP(), []int{5}
}

func (x *SurveyReq) GetAppointmentId() string {
	if x != nil {
		return x.AppointmentId
	}
	return ""
...
func (x *SurveyReq) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *SurveyReq) GetDescription() string {
	if x != nil && x.Description != nil {
		return *x.Description
	}
	return ""
...
func (x *SurveyReq) GetStatus() SurveyStatus {
	if x != nil {
		return x.Status
	}
	return SurveyStatus_unpublished
...
func (x *SurveyReq) GetPrompts() *Prompt {
	if x != nil {
		return x.Prompts
	}
	return nil
...
type Measure struct {
	...
	// Types that are assignable to MeasureOneof:
	//
	//	*Measure_Range
	//	*Measure_Boolean
	//	*Measure_Enumeration
	//	*Measure_Flags
	MeasureOneof isMeasure_MeasureOneof `protobuf_oneof:"measure_oneof"`
}
...
func (m *Measure) GetMeasureOneof() isMeasure_MeasureOneof {
	if m != nil {
		return m.MeasureOneof
	}
	return nil
}

func (x *Measure) GetRange() *MeasureRange {
	if x, ok := x.GetMeasureOneof().(*Measure_Range); ok {
		return x.Range
	}
	return nil
}
...
func (x *Measure) GetBoolean() *MeasureBoolean {
	if x, ok := x.GetMeasureOneof().(*Measure_Boolean); ok {
		return x.Boolean
	}
	return nil
}
...
func (x *Measure) GetEnumeration() *MeasureEnum {
	if x, ok := x.GetMeasureOneof().(*Measure_Enumeration); ok {
...
func (x *Measure) GetFlags() *MeasureFlags {
	if x, ok := x.GetMeasureOneof().(*Measure_Flags); ok {
		return x.Flags
	}
	return nil
}

type isMeasure_MeasureOneof interface {
	isMeasure_MeasureOneof()
}

type Measure_Range struct {
	Range *MeasureRange `protobuf:"bytes,10,opt,name=range,proto3,oneof"`
}

type Measure_Boolean struct {
	Boolean *MeasureBoolean `protobuf:"bytes,11,opt,name=boolean,proto3,oneof"`
}

type Measure_Enumeration struct {
	Enumeration *MeasureEnum `protobuf:"bytes,12,opt,name=enumeration,proto3,oneof"`
}

type Measure_Flags struct {
	Flags *MeasureFlags `protobuf:"bytes,13,opt,name=flags,proto3,oneof"`
}

func (*Measure_Range) isMeasure_MeasureOneof() {}

func (*Measure_Boolean) isMeasure_MeasureOneof() {}

func (*Measure_Enumeration) isMeasure_MeasureOneof() {}

func (*Measure_Flags) isMeasure_MeasureOneof() {}
...
var file_rpc_survey_service_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0x26, 0x0a, 0x0c, 0x4d,
	0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x6c,
	0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x61, 0x62,
	0x65, 0x6c, 0x73, 0x22, 0x81, 0x02, 0x0a, 0x0a, 0x53, 0x75, 0x72, 0x76, 0x65, 0x79, 0x52, 0x65,
	...
	0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x61, 0x70, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74,
	...
	,
	...
	,
	...
	,
...
var file_rpc_survey_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_rpc_survey_service_proto_goTypes = []interface{}{
	...
	(*SurveyReq)(nil),      // 7: skillsdemo.SurveyReq
	(*Prompt)(nil),         // 8: skillsdemo.Prompt
	(*Measure)(nil),        // 9: skillsdemo.Measure
}
var file_rpc_survey_service_proto_depIdxs = []int32{
	0,  // 0: skillsdemo.SurveyResp.status:type_name -> skillsdemo.SurveyStatus
	8,  // 1: skillsdemo.SurveyResp.prompts:type_name -> skillsdemo.Prompt
	0,  // 2: skillsdemo.SurveyReq.status:type_name -> skillsdemo.SurveyStatus
	8,  // 3: skillsdemo.SurveyReq.prompts:type_name -> skillsdemo.Prompt
	9,  // 4: skillsdemo.Prompt.response_type:type_name -> skillsdemo.Measure
	1,  // 5: skillsdemo.Measure.type:type_name -> skillsdemo.MeasureType
	2,  // 6: skillsdemo.Measure.range:type_name -> skillsdemo.MeasureRange
	3,  // 7: skillsdemo.Measure.boolean:type_name -> skillsdemo.MeasureBoolean
	4,  // 8: skillsdemo.Measure.enumeration:type_name -> skillsdemo.MeasureEnum
	5,  // 9: skillsdemo.Measure.flags:type_name -> skillsdemo.MeasureFlags
	7,  // 10: skillsdemo.Survey.MakeSurvey:input_type -> skillsdemo.SurveyReq
	6,  // 11: skillsdemo.Survey.MakeSurvey:output_type -> skillsdemo.SurveyResp
